function init()
{
    ...
    baddy1 = new Baddy("baddy1", 0xff00ff, new THREE.Vector2(-30, -30), 0);
    scene.add(baddy1.graphic);
...
{
    pointLight = new THREE.HemisphereLight(color, 50, 350);
